...
| US-08 | As a registered user, I want to reset my password using a password-reset link, so that I can regain access to my account in case I forget my password. | High | 5 | Backlog |
| US-09 | As an author, I want to edit my published posts, so that I can correct mistakes or update information after publishing. | Medium | 3 | Backlog |